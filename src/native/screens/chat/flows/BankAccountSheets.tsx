...
function SafetyNotice({ addAccount = false, children, colors }: { addAccount?: boolean; children: string; colors: AppColors }) {
  return (
    <View style={[styles.safetyNotice, { backgroundColor: colors.surfaceMuted, borderColor: '#BFD1FF', marginTop: addAccount ? 22 : 16 }]}>
      <View style={[styles.safetyIcon, { borderColor: '#BFD1FF' }]}><ShieldCheck color={colors.primaryDark} size={25} /></View>
...
const styles = StyleSheet.create({
  ...
  addContent: { paddingHorizontal: 16, paddingBottom: 24 },
  accountContent: { paddingHorizontal: 16, paddingBottom: 24 },
  description: { marginTop: 15, marginBottom: 20, fontSize: 12, lineHeight: 18, fontWeight: '600', textAlign: 'center' },
  addScreenDescription: { marginBottom: 22 },
  sectionTitle: { marginTop: 18, marginBottom: 10, fontSize: 15, fontWeight: '900' },
  qrUploadCard: { minHeight: 96, borderWidth: 1, borderRadius: 14, padding: 13, flexDirection: 'row', alignItems: 'center', gap: 12 },
  qrUploadIcon: { width: 60, height: 60, borderWidth: 1, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  qrUploadTitle: { fontSize: 13, fontWeight: '900' },
  qrUploadDescription: { marginTop: 5, fontSize: 10, lineHeight: 15, fontWeight: '600' },
  qrUploadButton: { minHeight: 44, borderWidth: 1, borderRadius: 10, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 4 },
  qrUploadButtonText: { fontSize: 12, fontWeight: '900' },
  label: { marginTop: 14, marginBottom: 7, fontSize: 12, fontWeight: '600' },
  bankSelect: { minHeight: 56, borderWidth: 1, borderRadius: 12, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  bankSelectIdentity: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10, overflow: 'hidden' },
  bankSelectText: { flex: 1, fontSize: 13, fontWeight: '800' },
  bankPicker: { borderWidth: 1, borderRadius: 12, marginTop: 6, overflow: 'hidden' },
  bankPickerOption: { minHeight: 58, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 10 },
  bankPickerLogo: { width: 55, alignItems: 'center' },
  bankPickerName: { flex: 1, fontSize: 12, fontWeight: '800' },
  bankQuickGrid: { flexDirection: 'row', gap: 7 },
  bankQuickCard: { flex: 1, minWidth: 0, minHeight: 98, borderWidth: 1, borderRadius: 12, paddingHorizontal: 4, alignItems: 'center', justifyContent: 'center', gap: 7 },
  bankQuickName: { maxWidth: '100%', fontSize: 9.5, fontWeight: '800', textAlign: 'center' },
  input: { minHeight: 56, borderWidth: 1, borderRadius: 12, paddingHorizontal: 14, fontSize: 13, fontWeight: '600' },
  search: { minHeight: 54, borderWidth: 1, borderRadius: 13, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 10 },
  searchInput: { flex: 1, minHeight: 50, paddingVertical: 0, fontSize: 13, fontWeight: '600' },
  savedLabel: { marginTop: 22, marginBottom: 10, fontSize: 12, fontWeight: '600' },
  list: { gap: 9 },
  card: { minHeight: 112, borderWidth: 1, borderRadius: 14, padding: 13, flexDirection: 'row', alignItems: 'center', gap: 13 },
  logo: { width: 68, height: 68, borderWidth: 1, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  grow: { flex: 1, minWidth: 0 },
  bankName: { fontSize: 15, fontWeight: '900' },
  bankNumber: { marginTop: 8, fontSize: 13, fontWeight: '700' },
  bankOwner: { marginTop: 6, fontSize: 12, fontWeight: '600' },
  ...
  empty: { minHeight: 100, borderWidth: 1, borderRadius: 14, alignItems: 'center', justifyContent: 'center', padding: 16 },
  emptyText: { fontSize: 12, fontWeight: '600', textAlign: 'center' },
  addAccount: { minHeight: 70, borderWidth: 1, borderRadius: 13, paddingHorizontal: 13, flexDirection: 'row', alignItems: 'center', gap: 11 },
  addIcon: { width: 44, height: 44, borderWidth: 1, borderRadius: 22, alignItems: 'center', justifyContent: 'center' },
  addTitle: { fontSize: 12, fontWeight: '900' },
  addDescription: { marginTop: 4, fontSize: 10, fontWeight: '600' },
  safetyNotice: { borderWidth: 1, borderRadius: 14, padding: 13, flexDirection: 'row', alignItems: 'center', gap: 10 },
  safetyIcon: { width: 42, height: 42, borderWidth: 1, borderRadius: 21, alignItems: 'center', justifyContent: 'center' },
  safetyText: { flex: 1, fontSize: 11, lineHeight: 17, fontWeight: '600' },
  ...
  primaryButton: { flex: 1, minHeight: 52, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
