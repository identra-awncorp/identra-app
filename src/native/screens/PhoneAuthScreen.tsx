...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 18, lineHeight: 24, fontWeight: '700' },
  phoneField: { minHeight: 64, borderWidth: 1.25, borderRadius: 15, flexDirection: 'row', alignItems: 'stretch' },
  ...
  smsHint: { minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: 13 },
  hintIcon: { width: 38, height: 38, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  hintText: { flex: 1, fontSize: 14, lineHeight: 21, fontWeight: '400' },
  ...
  checkbox: { width: 28, height: 28, borderWidth: 1.25, borderRadius: 7, alignItems: 'center', justifyContent: 'center' },
  consentText: { flex: 1, fontSize: 14, lineHeight: 21, fontWeight: '400' },
  continueButton: { minHeight: 58, borderRadius: 16, overflow: 'hidden', marginTop: 32 },
  ...
  securityTitle: { fontSize: 16, lineHeight: 22, fontWeight: '700' },
  securityDescription: { fontSize: 14, lineHeight: 22, fontWeight: '400' },
