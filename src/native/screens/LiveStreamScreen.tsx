...
const liveStreamImage = require('../../assets/images/news-feed-demo/8d353b31-b11d-443f-b55c-5760f92e2068.png');
...
const liveViewerAvatarAlt = require('../../assets/images/chat-list-demo-icon/photo_2026-06-21_11-00-03.jpg');
        ...
        >
          <View style={styles.topArea}>
            <View style={styles.header}>
              ...
              <View style={styles.hostInfo}>
                ...
                <View style={styles.hostMetaRow}>
                  <View style={styles.liveStatePill}>
                    <Text style={styles.liveStateText}>Đang phát trực tiếp</Text>
                  </View>
              ...
              <Pressable
                accessibilityRole="button"
                accessibilityLabel="Mở tùy chọn phát trực tiếp"
                style={({ pressed }) => [styles.glassButton, { opacity: pressed ? 0.68 : 1 }]}
              >
          ...
          <View style={styles.bottomArea}>
            ...
            <View style={styles.composerRow}>
              <Pressable accessibilityRole="button" accessibilityLabel="Viết bình luận" style={styles.commentInput}>
                <Text numberOfLines={1} style={styles.commentPlaceholder}>Viết bình luận...</Text>
                <Smile color={palette.white} size={22} strokeWidth={2} />
              </Pressable>
              <Pressable accessibilityRole="button" accessibilityLabel="Chia sẻ phát trực tiếp" style={styles.roundControl}>
                <Send color={palette.white} size={22} strokeWidth={2} />
              </Pressable>
              <Pressable accessibilityRole="button" accessibilityLabel="Thả tim" style={styles.heartControl}>
