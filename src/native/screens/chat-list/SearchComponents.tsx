...
import { type SearchIcon, type SearchMiniApp, type SearchPerson } from './ChatListData';
...
export function ConnectedPersonRow({
  ...
  return (
    <Pressable
      accessibilityRole="button"
      accessibilityLabel={`Mở kết nối ${person.name}`}
...
export function MiniAppRow({
  ...
  return (
    <Pressable
      accessibilityRole="button"
      accessibilityLabel={`Mở mini app ${app.name}`}
