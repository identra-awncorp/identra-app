...
export const QUICK_AVATAR_SIZE = 68;
export const QUICK_AVATAR_INNER_SIZE = 62;
export const QUICK_CONTACT_WIDTH = 86;
export const THOUGHT_BUBBLE_WIDTH = 86;
export const THOUGHT_BUBBLE_HEIGHT = 42;
export const THOUGHT_BUBBLE_OVERLAP = 7;
export const THOUGHT_BUBBLE_MAX_LENGTH = 60;
export const LIST_AVATAR_SIZE = 56;
export const CHAT_LIST_HEADER_HEIGHT = 62;
export const verifiedBadgeIcon = require('../../../assets/images/verified-badge-icon.png');
export type SearchCategory = 'all' | 'people' | 'apps';
...
export const searchMiniApps = [
  {
    ...
    textColor: '#111111',
    logoSource: require('../../../assets/images/mini-app-logo/bee-icon.png'),
  },
  {
    id: 'public-service',
    name: 'Dịch vụ công',
    ...
    textColor: '#FFD66B',
    logoSource: require('../../../assets/images/mini-app-logo/quoc-huy-vn-icon.png'),
  },
  {
    id: 'idpay',
    name: 'IDPay',
...
export const reelDemoImages = {
  sunset: require('../../../assets/images/reels-demo/fa12ad96-bc50-4503-b292-ac1afdd99407.png'),
